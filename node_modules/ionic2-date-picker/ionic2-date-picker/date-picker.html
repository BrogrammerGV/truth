<div class="layout-col horizontal-center" style="background-color:white;height: 30%;
    width: 80%;
    margin-top: 15%;
    margin-left: 10%;">
  <div class="layout-col horizontal-center top-banner">    <div class="dayofweek padding-5">{{currentMoment.format('dddd')}}</div>
